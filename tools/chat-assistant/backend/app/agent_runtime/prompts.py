...
_FALLBACK_PROMPTS: dict[str, str] = {
    ...
    "contract_risk_domain_analysis": (
        ...
        "5a. When domain.subCheckItems is supplied, it is the complete checklist for this domain. Inspect "
        "every listed item against the shared evidence bundle before concluding. Do not manufacture one "
        "finding per item; return findings only for material risks, but cover clean items in domainConclusion.\n"
