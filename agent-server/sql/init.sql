...
CREATE TABLE `agent_run` (
  ...
  `subject_type` VARCHAR(32) DEFAULT 'PROJECT',
  ...
  `error_message` TEXT,
  `limited_diagnostics` JSON DEFAULT NULL,
  `workflow_id` BIGINT DEFAULT NULL,
  `workflow_stage` VARCHAR(64) DEFAULT NULL,
  `evidence_snapshot_hash` VARCHAR(128) DEFAULT NULL,
  `runtime_engine` VARCHAR(32) DEFAULT NULL,
  `graph_name` VARCHAR(128) DEFAULT NULL,
  ...
  `rerank_version` VARCHAR(64) DEFAULT NULL,
  `scorer_version` VARCHAR(64) DEFAULT NULL,
  `initiated_by` BIGINT DEFAULT NULL,
  `document_snapshot_json` LONGTEXT,
...
CREATE TABLE `agent_report` (
  ...
  `scoring_version` VARCHAR(30) DEFAULT NULL,
  `evidence_hash` VARCHAR(64) DEFAULT NULL,
  `analysis_mode` VARCHAR(80) DEFAULT NULL,
